public class Seeder {
    public void Ayuda() {
        ...
        Administrator ad1 = new Administrator(p1, "andy", "123", true);
        RepositorySuperAdministrator.Admins.add(ad1);

        //admin2

        Date d2 = new Date(21, 11, 85);
        Profile p2 = new Profile("Aldo", "Meza", d2);
        Administrator ad2 = new Administrator(p2, "Calder", "1234", false);
        ad2.addPermissions();
       RepositorySuperAdministrator.Admins.add(ad2);

        //admin3

        Date d3 = new Date(19, 04, 98);
        Profile p3 = new Profile("Axel", "Sandoval", d3);
        Administrator ad3 = new Administrator(p3, "Cam", "12345", false);
        ad3.addPermissions();
        RepositorySuperAdministrator.Admins.add(ad3);
